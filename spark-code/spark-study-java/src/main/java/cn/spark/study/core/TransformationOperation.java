...
//		 sortByKey();
    ...
    private static void filter() {
        ...
        // 来判断这个元素是否是你想要的
        // 如果你想在新的RDD中保留这个元素，那么就返回true；不想保留这个元素，返回false
...
//				return Arrays.asList(t.split(" "));
    ...
    private static void reduceByKey() {
        ...
        List<Tuple2<String, Integer>> scoreList = Arrays.asList(
                ...
                new Tuple2<String, Integer>("class1", 90),
                new Tuple2<String, Integer>("class2", 65));
        //这种方法是不行的 def parallelizePairs[K, V](list : java.util.List[scala.Tuple2[K, V]])
        //源码中接受的就是tuple2类型的
...
//		map4.put("class2", 65);
//		List<HashMap<String, Integer>> scoreList = Arrays.asList(
//				map1,
//				map2,
//				map3,
//				map4);
...
//				new Tuple2<Integer, Integer>(3, 60));
    ...
    private static void cogroup() {
        ...
        List<Tuple2<Integer, String>> studentList = Arrays.asList(
                new Tuple2<Integer, String>(1, "leo"),
                new Tuple2<Integer, String>(2, "jack"),
                new Tuple2<Integer, String>(2, "chengfei"),
                new Tuple2<Integer, String>(3, "tom"));
